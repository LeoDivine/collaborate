...
export default function AdminBarChart({
	...
	const [view, setView] = useState<"projects" | "monthly" | "priority" | "status">("projects");

	// Direct live database data
			...
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
				<div>
					...
					<p className="text-[12px] opacity-75 mt-0.5 text-primary">
						Team workload allocation, project throughput, and status & priority distribution
					</p>
				</div>
